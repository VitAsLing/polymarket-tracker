...
export const zh: Messages = {
  ...
  error: {
    ...
    failedRank: '❌ 获取排名失败',
    langUsage: '❌ 支持: en, zh',
    maxSubscriptions: '❌ 已达订阅上限 (20个)，请先用 /unsub 取消部分订阅',
    thresholdInvalid: '❌ 金额无效。用法: /th 100 (或 /th 0 关闭过滤)',
  },
...
_地址格式: 0x..._`,
  ...
  filter: {
    current: '🔍 *当前过滤:*\n模式: {mode}\n分类: {categories}',
    none: '🔍 未设置过滤 (推送所有分类)\n\n用法:\n/ft +nba,epl - 只推送这些\n/ft -lol,atp - 跳过这些\n/ft off - 关闭过滤',
    set: '✅ 过滤已设置: {mode} {categories}',
    disabled: '✅ 已关闭过滤 (推送所有分类)',
    invalidUsage: '❌ 用法错误\n\n示例:\n/ft +nba,epl - 只推送这些\n/ft -lol,atp - 跳过这些\n/ft off - 关闭过滤',
    include: '只推送',
    exclude: '跳过',
  },
